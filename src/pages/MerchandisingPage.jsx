    ...
    items: [
      {
        ...
        icon: "apparel",
        image: "/productos/camisetas.webp",
        images: ["/productos/camisetas.webp"],
    ...
    items: [
      {
        ...
        icon: "coffee",
        image: "/productos/mugs.webp",
        images: ["/productos/mugs.webp"],
      ...
      },
      {
        ...
        materialsTitle: "🏅 Materiales:",
        papers: ["Aleación metálica Zamak con baño dorado/plateado", "Cinta satinada de 2.5 cm", "Cartulina Maule o Kraft plegadiza para cajas" ],
        formatsTitle: "📐 Tamaños:",
        formats: ["Medallas de 5 cm, 6 cm y 7 cm de diámetro", "Cajas a la medida del producto"],
        finishesTitle: "🎨 Técnica de personalización:",
        finishes: ["Esmaltado a color con resina", "Cinta sublimada con logo", ],
        quantities: ["25", "50", "100", "250", "500+"],
      },
      {
        title: "Carnets & Sellos",
        ...
        icon: "badge",
        image: "/productos/carnets_sellos.webp",
        images: ["/productos/carnets_sellos.webp"],
        badge: "Identidad & Seguridad",
        materialsTitle: "📦 Materiales:",
        papers: ["PVC calibre 30 (tipo tarjeta de crédito)", "Cinta de poliéster de 2 cm", "Sellos automáticos Trodat / Shiny"],
        formatsTitle: "📐 Formatos:",
        formats: ["Carnet estándar 8.5 x 5.4 cm", "Yoyo retráctil o mosquetón metálico", "Sellos de bolsillo o de escritorio (38 x 14 mm hasta 70 x 25 mm)"],
        finishesTitle: "🎨 Técnica de personalización:",
        finishes: ["Impresión térmica doble cara", "Laminado de seguridad holográfico", "Cinta sublimada con broche de seguridad", "Sello con placa grabada en caucho láser"],
